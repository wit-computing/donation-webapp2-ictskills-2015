...
/**
 * Use ajax call to get users and their geolocations pass returned array marker locations to callback method
 */
...
/**
 * Put data into an array using format is 'user, xx.xxxx, yy.yyyyy' -> (user, lat, lng) 
...
/**
 * A helper function to convert the latlng string to individual numbers and thence to a google.maps.LatLng object
 */
